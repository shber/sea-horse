...
Page({
    ...
    toAddProduct: function(t) {
        wx.navigateTo({
            url: "../product/index?store_id=" + this.data.store.id
        });
    },
    myProduct: function(t) {
        wx.navigateTo({
            url: "../product/list/index?store_id=" + this.data.store.id
        });
    },
    myOrder: function(t) {
        wx.navigateTo({
            url: "../product/order/index?store_id=" + this.data.store.id
        });
    },
