...
Page({
    ...
    chooseImage: function(t) {
        ...
        if (1 != a) {
            if (2 == a) {
                var n = e.siteInfo.siteroot.replace("app/index.php", "app/index.php") + "?i=" + e.siteInfo.uniacid + "&c=utility&a=file&do=upload&thumb=0";
                wx.chooseImage({
                    success: function(t) {
            ...
            count: 1,
            success: function(t) {
                var a = e.siteInfo.siteroot.replace("app/index.php", "app/index.php") + "?i=" + e.siteInfo.uniacid + "&c=utility&a=file&do=upload&thumb=0";
                wx.uploadFile({
                    url: a,
